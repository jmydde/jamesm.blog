...
The Endurance reaches another galaxy through what Romilly describes as a "gravitational anomaly" parked near Saturn. It is, of course, a [wormhole](https://en.wikipedia.org/wiki/Wormhole) - a tunnel in spacetime that connects two distant points without traversing the space between them.
...
Gargantua is the centrepiece of the film's middle act and the reason its visual effects pipeline produced an actual research paper. It is depicted as a [Kerr black hole](https://en.wikipedia.org/wiki/Kerr_metric) - a rotating one - with a mass of about a hundred million Suns.
...
To render Gargantua, Double Negative built a renderer called DNGR - the [Double Negative Gravitational Renderer](https://arxiv.org/abs/1502.03808). Rather than tracing single rays, it traced bundles of rays through curved spacetime, integrating the geodesic equations for a Kerr black hole.
...
That is a [gravitational time dilation](https://en.wikipedia.org/wiki/Gravitational_time_dilation) factor of about 60,000. Time on the planet, deep in Gargantua's gravitational well, runs vastly slower than time for an observer far from the black hole.
...
The framing here draws on [brane cosmology](https://en.wikipedia.org/wiki/Brane_cosmology), a branch of theoretical physics related to string theory and M-theory. The idea is that the four-dimensional spacetime we inhabit might be a "brane" embedded in a higher-dimensional "bulk." Most physical phenomena - light, matter, the strong and weak nuclear forces - are confined to the brane. Gravity, in some versions of the theory, is the exception. It can leak into the bulk, which is why it appears so weak compared to the other forces.
...
**Miller's planet** is a global ocean with periodic kilometre-high waves. The film attributes these to tidal forces from Gargantua. This is broadly plausible - the planet is so close to the black hole that it sits near the [Roche limit](https://en.wikipedia.org/wiki/Roche_limit) where tidal forces would otherwise tear a body apart. A more rigorous treatment would have the planet [tidally locked](https://en.wikipedia.org/wiki/Tidal_locking) almost instantly - the same face permanently aimed at Gargantua - which would change the tide pattern significantly. The film glosses over this for the sake of staging two enormous waves crashing across the set.
...
- [Why Spacecraft Don't Just Slow Down Before Reentry](https://jamesm.blog/space/why-spacecraft-dont-slow-down-before-reentry/)
- [Human Spaceflight Rockets in 2026](https://jamesm.blog/space/human-spaceflight-rockets-2026/)
- [Artemis II Distance Record](https://jamesm.blog/space/artemis-ii-distance-record/)
- [SpaceX Starship vs NASA SLS](https://jamesm.blog/space/spacex-starship-vs-nasa-sls/)
- [NASA Artemis II](https://jamesm.blog/space/nasa-artemis-ii/)

Further authoritative reading:

- [NASA: Black Holes](https://science.nasa.gov/universe/black-holes/)
- [Wikipedia: Interstellar (film)](https://en.wikipedia.org/wiki/Interstellar_(film))
- [Wikipedia: Kip Thorne](https://en.wikipedia.org/wiki/Kip_Thorne)
- [arXiv: Gravitational Lensing by Spinning Black Holes - James, von Tunzelmann, Franklin, Thorne](https://arxiv.org/abs/1502.03808)
