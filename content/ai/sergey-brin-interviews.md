...
Most founders of Sergey Brin's vintage and net worth do not come back to write code. Brin did. He stepped away from Google in 2019, and when the frontier of AI started moving faster than anyone expected, he returned in 2023 to work hands-on on [Gemini](https://gemini.google.com/) - by his own account because staying retired through this particular moment in computing would have been a mistake. That makes his public commentary an unusually direct read on how Google sees the race, and it is why I keep this page. It is a growing, chronological index of his interviews, talks, and appearances, with enough context around each to know what you are clicking into.

## TL;DR

- A growing collection of interviews with **Sergey Brin**, [Google](https://about.google/) co-founder and an active voice on AI now that he is back hands-on at Google working on [Gemini](https://gemini.google.com/)
...
- Brin's return to coding in 2023-2024 makes him an unusually direct signal of how Google is positioning itself against [OpenAI](https://openai.com/), [Anthropic](https://www.anthropic.com/), and the rest of the frontier lab field
...
Sergey Brin co-founded [Google with Larry Page in 1998](https://about.google/our-story/) while a PhD student at Stanford. He stepped back from day-to-day operations at parent company [Alphabet](https://abc.xyz/) in 2019, but returned to active engineering work on Gemini in 2023 as the competitive pressure from frontier AI labs intensified - later saying he had been "spiraling" in retirement and that staying out [would have been a big mistake](https://fortune.com/2025/12/15/sergey-brin-spiraling-before-returning-to-google-gemini-retirement/).

A few things make his voice distinctive in the current AI conversation:

- **Hands-on, not above-it-all**: Brin is reportedly in the office most days and writing code, which is unusual for a founder of his vintage and net worth. His interviews tend to be more technical and less PR-shaped than the typical executive appearance, and [Demis Hassabis](https://deepmind.google/about/) has described him as being "in the weeds, programming" on the Gemini models.
...
- **Public scepticism of humanoid robotics**: He has argued that AI can learn from simulation without needing a humanoid form, putting him at odds with the [Figure](https://www.figure.ai/), [1X](https://www.1x.tech/), and Tesla Optimus camps.
- **An aggressive AGI line**: At [Google I/O 2025 he made a surprise appearance](https://venturebeat.com/ai/at-google-i-o-sergey-brin-makes-surprise-appearance-and-declares-google-will-build-the-first-agi) and said Google "fully intends" Gemini to be the very first AGI, putting the milestone before 2030 - more aggressive than Hassabis, who placed it just after, and more aggressive than the wider Google PR position usually suggests.
