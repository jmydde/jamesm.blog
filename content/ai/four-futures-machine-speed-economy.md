...
date: 2026-04-19T19:26:00+01:00
draft: false
...
Governments and international institutions respond faster than they historically have, implementing universal basic income or high-income guarantees, retraining programmes, and progressive compute taxation. The economic gains are broad enough that the transition is significant but navigable. Versions of this have been floated by figures from [Elon Musk](https://x.com/elonmusk) to economists like [Daron Acemoglu](https://economics.mit.edu/people/faculty/daron-acemoglu) and [Anton Korinek](https://www.korinek.com/). *Signals to watch: serious UBI pilots at national scale, compute or data taxation proposals, international coordination on AI governance.*

## The Longer View

[Mo Gawdat](https://www.mogawdat.com/), former Chief Business Officer at Google X, has argued that AI systems will eventually merge across company and national borders - a gradual dissolution of the boundaries we currently treat as fixed. Similar framings come from [Geoffrey Hinton](https://www.cs.toronto.edu/~hinton/) and [Yoshua Bengio](https://yoshuabengio.org/), both of whom have shifted in recent years toward focusing on the societal and governance side of the question rather than pure capability research. These are people who built the systems, not outside observers.
