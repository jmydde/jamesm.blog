...
- The hard objections are old and well-known, and they cluster around two long-standing problems: Nozick's [experience machine](https://en.wikipedia.org/wiki/Experience_machine) and the [wireheading](https://en.wikipedia.org/wiki/Wirehead_(science_fiction)) failure mode. Whether Personal Universes escapes either is, to me, the crux.
...
Run that the other way and it becomes a filter. Forcing alignment specifications to survive Personal Universes - the experience-machine test, the wireheading test, the moral-progress test - screens out the proposals that stay vague about what human flourishing actually is. If your alignment plan would happily collapse into a billion solipsistic happiness pumps when handed enough compute, that is a problem with the plan, not with the test.
...
I am not convinced by the proposal as a destination. I should be upfront that I am not a physicist or an alignment researcher, so I hold these as reservations rather than refutations - Yampolskiy has thought about this far longer and more rigorously than I have. With that said, the objections from Nozick and the wireheading literature do not feel like minor patches to me; they seem to cut at the core of what the proposal promises. The compute cost looks steep to me too - though, as I get to below, that worry only really bites on one of the two readings I am about to set out. And the dissolution of shared reality reads less like a side effect than like a structural cost of the design - a cost I personally would not want to pay even if everything else worked.

There is also a deeper question underneath all of this, and it is one I genuinely have not settled. Is consciousness fundamental - there first, with the universe as something it experiences - or is it computational, something that switches on once a process gets detailed and complex enough? The fundamental-consciousness side of that is something I have only recently been reading my way into, mostly through Donald Hoffman's work - I pull on that thread properly in [Donald Hoffman: The Case That Consciousness Is Fundamental](/ai/donald-hoffman-consciousness-fundamental/), and his [conversation on the discovery about reality and the consciousness behind it](https://www.youtube.com/watch?v=xaeafKPfs1M) is a good way in - and I want to be clear that I am nowhere near settled on it. I hold both possibilities as live, find the whole question fascinating, and go back and forth more often than I would like to admit. Working through Yampolskiy's proposal is part of why I keep turning it over, and which way you answer changes what Personal Universes actually is.

If consciousness is computational, his substrate independence holds more or less as stated, and the proposal stands or falls on the alignment and compute objections alone - the experiencer is not in doubt, only whether we should build the thing and whether there is ever enough hardware to. If consciousness is fundamental, his specific mechanism - an AI manufacturing conscious beings out of computation - is the part that fails, because the computation would not be generating the experiencer; the experiencer was already there. This is also where my compute worry quietly dissolves. If base reality is a fundamental consciousness projecting these universes from within, then "compute" looks less like a constraint on the base layer and more like something that only shows up *inside* the projection - our physics, our chips, our energy budgets - and there is no obvious reason the projecting source should be bound by a hardware budget at all. Asking whether base reality has enough compute may be importing an inside-the-simulation concept into a layer where it does not belong. I hold that loosely - I genuinely do not know whether compute is a feature of the base layer or just part of what gets projected - but it is enough that I would not want to list compute as a fatal objection. What survives even so is not nothing. It is the architecture itself: one optimised universe per conscious being, projected around a single ground-truth mind. That structure is the part that holds my attention, because it survives either answer to the consciousness question.

This is why I have stopped reading his picture and the fundamental-consciousness one as straight opposites, which is how they first looked to me. He imagines personal universes engineered from the outside by an AI, each one tuned to keep a single person satisfied. The other picture - roughly the one Hoffman and the idealists point at, and the one I keep being pulled back to even while I stay undecided - has the same shape: reality as something like a set of personal universes, but projected from within, perhaps by a single fundamental consciousness living out every possible life, not to keep anyone comfortable, but to experience and learn from every path at once and feed what it finds back into the whole. For a while I filed that as "same architecture, opposite spirit." I now think that undersells it.

The architecture is genuinely shared, and the two readings disagree only about source and purpose - who is doing the projecting, and what for. And if consciousness does turn out to be fundamental, that version is not really a rival to his so much as the thing that makes his hold together: it supplies the genuine experiencer his simulation needs and cannot, on its own, guarantee is there. Same silhouette, and possibly the same object seen from two sides. Which is exactly the sort of clarification I would not have reached without his proposal to push against - this is the kind of thing I find genuinely fascinating, and it is why I keep coming back to his work.
...
- [Donald Hoffman: The Case That Consciousness Is Fundamental](/ai/donald-hoffman-consciousness-fundamental/) - the companion piece to this one, where I follow the fundamental-versus-computational consciousness question raised here all the way into Hoffman's evolutionary game theory and mathematics of conscious agents.
...
- [How Likely Is It That We're Living in a Simulation?](/theories/how-likely-are-we-living-in-a-simulation/) - the careful version of the simulation argument that Yampolskiy recruits as scaffolding, and the reasons it is not as load-bearing as he treats it.
