...
- [Is Reality Made of Mathematics?](/theories/is-reality-made-of-mathematics/) - Tegmark's structural picture of reality, which is broadly computational about mind and runs into the same hard problem from the physics side.
- [How Likely Is It That We're Living in a Simulation?](/theories/how-likely-are-we-living-in-a-simulation/) - why the computational-versus-fundamental answer directly changes how seriously to take the simulation argument.
