...
date: 2026-04-20T21:45:00+01:00
draft: true
...
cover:
  image: /assets/images/ai/reading-the-signals-four-futures.jpg
...
The strongest evidence for this scenario remains inference cost deflation. The per-token price of frontier-class intelligence has fallen by more than two orders of magnitude since GPT-4's debut, and the gap between open-weight models and closed frontier systems has narrowed further with [Meta's Llama line](https://ai.meta.com/llama/), [Mistral](https://mistral.ai/), [DeepSeek](https://www.deepseek.com/), and [Qwen](https://qwenlm.github.io/) all shipping genuinely competitive releases. For a developer or a small business, the cost of applied intelligence in 2026 is a rounding error compared to 2023.

Healthcare and education cost curves are the weaker part of the story. AI tutoring is getting measurably better - [Khan Academy's Khanmigo](https://www.khanmigo.ai/) and a wave of similar tools are quietly doing real work - but tuition and insurance premiums have not moved. The productivity gains are real at the tool level and invisible at the institutional level, which is a pattern worth taking seriously on its own.
...
Platform lock-in of agentic workflows is the signal that has moved most in the last six months. A year ago, people were talking about agents in the abstract; today real work is being done inside [Claude Code](/ai/claude-code-vs-cursor), [Cursor](https://cursor.com/), [Devin](https://www.cognition.ai/), and a widening roster of vertical agent products. Switching costs are beginning to accrue in the form of memory, context, integrations, and workflow muscle memory - the same way they accrued around email, cloud storage, and CRM a decade ago.

Payment rail consolidation is harder to read. [Stripe](https://stripe.com/) and [Adyen](https://www.adyen.com/) are expanding, [stablecoin infrastructure](https://www.circle.com/) is maturing, and several central banks have accelerated digital currency pilots. Physical cash use keeps declining in most developed economies. None of this is dystopian on its own; the question is whether the combination of agentic platforms, consolidated payments, and digital identity produces a stack where individual exit becomes genuinely hard.

Competition enforcement is the one place this scenario has met real resistance. The [FTC](https://www.ftc.gov/), the [European Commission](https://commission.europa.eu/), and the UK's [CMA](https://www.gov.uk/government/organisations/competition-and-markets-authority) have all opened meaningful investigations into cloud, AI, and app-store dynamics in the last eighteen months. Whether those investigations produce structural remedies or just consent decrees is the real test.
...
This is the weakest of the four scenarios by the signal test. Serious UBI pilots have not scaled to national level anywhere. [Sam Altman's Worldcoin/World ID work](https://worldcoin.org/) continues, and there are small-scale trials in [Finland](https://www.kela.fi/) history, [Kenya via GiveDirectly](https://www.givedirectly.org/), and a handful of US cities, but nothing that meaningfully redistributes AI-driven productivity gains at a population scale.

Compute or data taxation has been floated by [Daron Acemoglu](https://economics.mit.edu/people/faculty/daron-acemoglu) and others but remains a paper proposal rather than legislation. International coordination on AI governance is somewhere between the [Bletchley](https://www.gov.uk/government/topical-events/ai-safety-summit-2023) and [Seoul](https://www.aisafetysummit.gov.uk/) summit communiqués and the [EU AI Act](https://artificialintelligenceact.eu/) implementation timeline - real diplomatic activity, modest binding effect so far.
...
1. Whether the open-weight frontier gap keeps widening or closes again. This is the abundance-versus-concentration fulcrum.
2. Whether agentic memory and context become portable across platforms, or get locked in. This is the feudalism fulcrum.
3. Whether any serious economy moves past pilot-scale on redistribution of AI gains. This is the managed-transition fulcrum.
