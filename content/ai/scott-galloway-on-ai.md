---
title: "Scott Galloway on AI: The Marketing Professor's Case That the Rich Don't Need You Anymore"
date: 2026-05-04T22:31:00+01:00
draft: false
tags: ["ai", "economy", "business", "future-of-work", "idea"]
...
- Scott Galloway is a clinical professor of marketing at [NYU Stern School of Business](https://www.stern.nyu.edu/faculty/bio/scott-galloway) and host of *The Prof G Pod*, *Prof G Markets*, and *Pivot* with Kara Swisher.
...
- His central economic claim about AI is that the United States in 2026 is "a giant bet on AI" and that the current valuations look like a late-stage bubble. He has been particularly pointed about [OpenAI's circular financing arrangements](https://fortune.com/2025/11/10/scott-galloway-nowhere-to-hide-ai-bubble-sam-altman/) with Nvidia and Microsoft.
...
- He is the [New York Times bestselling author](https://en.wikipedia.org/wiki/Scott_Galloway_(professor)) of *The Four*, *The Algebra of Happiness*, *Post Corona*, *Adrift*, and *The Algebra of Wealth*.
...
Outside the classroom he has a long entrepreneurial record. He founded the e-commerce firm Red Envelope in 1997, the digital intelligence firm L2 Inc in 2010 - acquired by Gartner in 2017 for an aggregate purchase price of $134.2 million - and the executive-education startup Section (formerly Section4) in 2019. He has served on the boards of Eddie Bauer, Urban Outfitters, Gateway, The New York Times Company, and the Haas School of Business. He is a [TED speaker](https://www.ted.com/speakers/scott_galloway) with one of the most-viewed business talks of the last decade.
...
In the near term he expects [more disruption around the AI majors](https://fortune.com/2026/02/04/scott-galloway-predicts-openai-could-pull-its-ipo-amid-ai-vibe-shift-as-investors-gag-on-trump-proximity-questionable-revenue/) than the consensus is pricing in. He has predicted that OpenAI could pull or postpone its IPO, that the gap between frontier and open-weight models will compress further than is comfortable for the closed labs, and that one or more high-profile model labs will have a meaningful recapitalisation event before the end of the year. He is not predicting collapse; he is predicting that the story of inevitability gets a hard edit.
...
- [Four Futures for the Machine-Speed Economy](/ai/four-futures-machine-speed-economy/) - the four scenarios Galloway's bubble-and-distribution thesis maps most cleanly onto, and the signals that distinguish them.
- [The Free Intelligence Era: What Breaks When Thinking Costs Nothing](/ai/free-intelligence-era/) - a longer treatment of the labour-market dynamics Galloway gestures at when he says the rich no longer need ordinary workers.
- [The Automation Paradox: Why More AI Makes Human Judgment More Valuable](/ai/automation-paradox/) - the counterweight to the displacement story, and the reason Galloway's own advice is to invest in the things AI cannot do.
- [Career-Ops: Flipping the Script on AI-Powered Job Search](/ai/career-ops/) - a practical answer to the bargaining-position problem Galloway describes at the labour-market end.
- [Roman Yampolskiy: The Researcher Who Thinks AI Cannot Be Controlled](/ai/roman-yampolskiy/) - a different kind of AI critic, useful as a contrast to Galloway's economics-first frame.
