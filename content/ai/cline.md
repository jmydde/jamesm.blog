...
1. **Bring Your Own Key**: Use a high-reasoning model - Claude Sonnet 4.6 or Opus 4.6 for the bulk of agentic work, or a specialised "thinking" model via OpenRouter when you want to mix providers.
