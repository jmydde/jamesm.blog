...
The [Stanford AI Index](https://hai.stanford.edu/ai-index) tracks the supply side of this curve. Frontier compute capacity is growing at roughly 3.4x per year. Chip throughput is doubling on a similar cadence. Model efficiency is improving on top of that. Three exponentials stacked on each other do not produce a linear future. They produce a phase change.
...
This is not theoretical. It is the mechanism behind the [productivity studies](https://en.wikipedia.org/wiki/Productivity) showing AI-assisted writers, coders, and analysts producing more in less time. The studies focus on output per hour. The economic story underneath is the collapse of marginal cost.
