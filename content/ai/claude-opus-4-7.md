...
draft: false
type: brief
tags: ["claude", "model-release", "software-engineering", "ai"]
...
For developers used to [Claude Code](https://claude.com/claude-code), this matters. A longer-running development task - refactoring a module, building a feature with multiple moving parts, debugging a multi-file issue - no longer requires constant direction. You set it in motion and it handles the thinking.
