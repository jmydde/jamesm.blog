...
- **Contamination is rampant.** Independent reproduction studies estimate MMLU scores are inflated by 8-15 points on frontier models due to training data overlap. MMLU questions have been found verbatim in Common Crawl, the primary pre-training corpus.
