...
cover:
  ...
  alt: Geoffrey Hinton - AI Researcher and Pioneer
---
...
- An evolving collection of interviews with **Geoffrey Hinton**, the British-Canadian "Godfather of AI" whose work on [backpropagation](https://en.wikipedia.org/wiki/Backpropagation) underpins modern deep learning
- Hinton spent decades at the [University of Toronto](https://www.utoronto.ca/) and [Google](https://about.google/) before leaving in 2023 to speak more freely about AI risk
- The interviews trace the arc from foundational technical work to public warnings - including his [2024 Nobel Prize in Physics](https://www.nobelprize.org/prizes/physics/2024/summary/) for neural network research
...
- **Backpropagation**: Hinton was a co-author of the influential 1986 paper, with David Rumelhart and Ronald Williams, that popularised [backpropagation](https://en.wikipedia.org/wiki/Backpropagation) as a way to train multi-layer neural networks. The algorithm was not entirely new, but their work is what put it at the centre of the field. It remains the workhorse of essentially all modern deep learning.
...
- **Academia and industry**: Hinton spent decades at the [University of Toronto](https://www.utoronto.ca/) and later at Google Brain (2013-2023), which acquired his startup DNNresearch. He also co-founded and served as chief scientific adviser of the [Vector Institute](https://vectorinstitute.ai/) in Toronto, one of the major hubs of Canadian AI research.
- **Awards and recognition**: He shares the 2018 [Turing Award](https://en.wikipedia.org/wiki/Turing_Award) - often called the "Nobel Prize of computing" - with Yoshua Bengio and Yann LeCun, and in 2024 was awarded the [Nobel Prize in Physics](https://www.nobelprize.org/prizes/physics/2024/summary/) jointly with John Hopfield for foundational work on machine learning with neural networks.
