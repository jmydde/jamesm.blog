...
- This is the **sequel** to [What Does Expertise Mean When AI Can Pass Any Exam?](/ai/expertise-after-ai/) - less about broken credentials, more about what expertise becomes next
...
[Expertise After AI](/ai/expertise-after-ai/) argued that exams stopped measuring what we thought they measured. This post asks what replaces them - not as policy, but as a working picture of what practitioners will need to be good at by 2030.
...
1. **Site judgement the model never saw.** The borings showed acceptable bearing capacity on paper, but the engineer walked the abutment last month and knows the approach fill was placed in a wet season. The AI optimised for the soil report, not the mud line visible after the last flood.
2. **Stakeholder integration.** The city wants minimal lane closures; the fabricator wants fewer unique plate sizes; the maintenance crew needs access hatches the cleanest design omits. The expert holds those constraints in tension - none appear as rows in the calc sheet.
3. **Accountability under uncertainty.** The model recommends a retrofit scheme at 94% utilisation on the critical girder. The engineer accepts 88% because the corrosion pattern on the existing steel is worse than the photos in the training set suggested, and signs the drawing anyway.
4. **Teaching the next crew.** The apprentice learns not by copying tables but by watching which AI outputs get rejected and why - tacit transfer that no prompt library captures.
