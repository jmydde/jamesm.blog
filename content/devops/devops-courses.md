...
draft: false
tags: ['architecture', 'aws', 'azure', 'ci-cd', 'consul', 'course', 'database', 'devops', 'docker', 'gcp', 'git', 'gitops', 'hashicorp', 'iac', 'kubernetes', 'lambda', 'linux', 'networking', 'python', 's3', 'security', 'storage', 'terraform', 'training', 'vpc', 'whitepaper', 'vault']
...
- [GitHub](https://github.com/)
  - [Open Source Curriculum for CNCF Certification Courses](https://github.com/cncf/curriculum/)
    - [Certified Kubernetes Administrator (CKA)](https://github.com/cncf/curriculum/blob/master/CKA_Curriculum_v1.27.pdf/)
    - [Certified Kubernetes Application Developer (CKAD)](https://github.com/cncf/curriculum/blob/master/CKAD_Curriculum_v1.27.pdf/)
    - [Certified Kubernetes Security Specialist (CKS)](https://github.com/cncf/curriculum/blob/master/CKS_Curriculum_%20v1.26.pdf/)
