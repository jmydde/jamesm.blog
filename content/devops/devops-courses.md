...
draft: false
tags: ['architecture', 'aws', 'azure', 'cicd', 'courses', 'databases', 'db', 'devops', 'docker', 'gcp', 'git', 'gitops', 'iac', 'k8s', 'k8s', 'kubernetes', 'lambda', 'linux', 'networking', 'python', 's3', 'security', 'storage', 'training', 'vpc', 'whitepapers']
---
