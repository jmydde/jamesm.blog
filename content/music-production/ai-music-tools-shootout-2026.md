...
- **[Suno](https://suno.com/)** - text-to-song with the best vocal synthesis, now with a full DAW ([Suno Studio]({{< relref "suno-studio.md" >}})).
- **[Udio](https://www.udio.com/)** - the main challenger to Suno, popular for instrumental and genre-accurate output.
- **[AIVA](https://www.aiva.ai/)** - symbolic composition (MIDI-first), aimed at composers and scoring.
- **[Riffusion](https://www.riffusion.com/)** - spectrogram-based generation, strong for loops and experimental textures.

## Round 1: Vocal Quality

- **Suno** - still the leader. The v5 model handles vowel shapes, breath noise, and consonant articulation with a realism that was science fiction two years ago. [Mikey Shulman has talked about this at length]({{< relref "suno-mikey-shulman.md" >}}) and the [voice personas feature]({{< relref "suno-voice-personas.md" >}}) makes it easy to nail a specific tone.
...
- **Suno** and **Udio** have both faced [RIAA litigation](https://www.riaa.com/) and have since tightened their commercial-use terms. Read the licence on the plan you are paying for.
...
See also: [Patents, copyright, and clone synths]({{< relref "patents-copyright-clone-synths.md" >}}) for the wider context on IP in music tech.
...
- **Sketching ideas to finish in a real DAW:** any of them - treat the output as a starting point, export stems, and arrange in Ableton, Logic, or [your DAW of choice]({{< relref "best-music-production-software-2026.md" >}}).
