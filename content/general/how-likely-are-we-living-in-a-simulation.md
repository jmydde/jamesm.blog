...
- My view: as a request for a precise probability the question is malformed and deserves no number - but setting the arithmetic aside, I lean toward us not being in base reality, while staying genuinely in two minds about whether consciousness is fundamental or computational, a tension I unpack at the end.
...
In 2003, the philosopher Nick Bostrom published a paper called [*Are You Living in a Computer Simulation?*](https://simulation-argument.com/simulation.pdf). It does not argue for the conclusion that we are simulated. It argues that at least one of three propositions must be true:

1. Almost all civilizations at our stage go extinct before reaching technological maturity, the point where they could run enormous numbers of detailed simulations of their own ancestors.
2. Technologically mature civilizations almost never bother to run such "ancestor simulations," perhaps through lack of interest, ethics, or law.
3. We are almost certainly living in a computer simulation.

This is a trilemma, not a conclusion. Bostrom's [own position](https://simulation-argument.com/faq/), as far as I can tell, is roughly even credence spread across the three, not a confident vote for the third. The argument's real achievement is the structure: if you reject the first two, the third follows, and that is a genuinely uncomfortable place to be pushed.
...
A perfect simulation is, by construction, indistinguishable from base reality. If every possible observation comes out the same either way, then the hypothesis predicts nothing, forbids nothing, and explains nothing extra. By [Occam's razor](https://en.wikipedia.org/wiki/Simulation_hypothesis), piling realities on top of realities to explain a world that already looks self-consistent is a move you should resist unless something forces it.
...
In 2020, the Columbia astronomer David Kipping ran a Bayesian analysis, [written up in *Scientific American* under the headline "Chances Are about 50-50."](https://www.scientificamerican.com/article/do-we-live-in-a-simulation-chances-are-about-50-50/) He collapsed Bostrom's trilemma into a dilemma, since branches one and two both end with "no simulations exist," and weighed that against the simulation hypothesis. With a neutral prior, the result landed a hair under 50 percent. Slightly more likely that we are in base reality than not.
...
There is also a quieter response worth knowing. In *[Reality+](https://consc.net/reality/)* (2022), the philosopher David Chalmers argues that even if we are in a simulation, our world is not therefore fake. A simulated tree is still a real pattern; a simulated life still contains real joy and real loss. On this view the discovery would change the *substrate* of reality, not its *value*. It would be a fact about the basement, not a verdict on the house.

## My own view

As a request for a precise probability, I think the question is currently malformed. I cannot hand you an honest number, and I am wary of anyone who hands you one too confidently. But I am not going to hide behind that, because when I set the arithmetic aside and ask what I actually believe, I find I do have a strong lean: I think it is very likely we are not in base reality.
...
In the standard, computational telling of the story, the premise I find hardest to settle is the one about consciousness. I am honestly in two minds here, and I have stopped pretending otherwise. One part of me leans toward thinking consciousness is fundamental - not something that computation conjures up once it gets complicated enough, but part of the basic furniture of reality. The other part takes seriously that consciousness might be computational after all, something that genuinely does switch on when information processing gets rich enough. I go back and forth, and I no longer pretend to myself that I have landed. The two answers pull the simulation argument in opposite directions. If consciousness is fundamental, it does real damage to the counting argument, because the trillions of simulated minds it leans on might be flawless behavioural copies with no one home inside them - philosophical zombies do not belong in the census of observers. If consciousness is computational, those minds are genuine observers and the counting argument keeps its full force. That uncertainty is the honest state I am in. It does not prove we are in base reality either way; it just means the headcount that particular argument depends on may be far smaller than it assumes, or may not be at all.

When I try to say what I lean toward when pressed, it looks less like a server farm and more like a mind. I do not picture us as base-reality humans sitting in a lab with VR headsets strapped on, and I do not quite picture us as digital people who might secretly be running empty. I suspect something stranger: that we are the one base-reality consciousness - the superconscious I keep circling back to - projecting individual lives, and perhaps individual personal universes, so that it can live out every possible path. Infinite outcomes, experienced from the inside, all of them learned from at once and fed back into the whole. On that picture the zombie worry dissolves, because the one who is home in every life is the same fundamental consciousness wearing a different face each time. It is closer to a single mind dreaming many dreams than to aliens running a simulation on a computer. I cannot put a number on that, and I cannot defend it as physics. It is a metaphysical leaning, and I hold it as one - loosely, and alongside the live possibility that consciousness is computational after all, in which case a picture much closer to the conventional simulation story would be back on the table. This is where I lean when forced to choose, not a door I have closed.
...
### Gregory Benford - Are We Living in a Simulation?

{{< youtube 991q4oVAQ8E >}}

### Could Our Universe Be a Fake? - Episode 110
