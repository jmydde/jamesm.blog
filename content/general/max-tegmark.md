---
title: "Max Tegmark: The Physicist Who Took Mathematics All the Way Down"
...
I have written about one of [Max Tegmark](https://en.wikipedia.org/wiki/Max_Tegmark)'s ideas already - the [Mathematical Universe Hypothesis](/general/is-reality-made-of-mathematics/) - and in doing so I admitted he sits at the top of my [favourite physicists](/general/favourite-physicists/) list. That post was about a single claim. This one is about the man, and about the thing I find more interesting than any individual theory of his: the through-line. Tegmark has spent a career moving steadily inward, from measurable cosmology toward the deepest possible questions about what reality *is*, and the move never feels like a physicist losing the plot and drifting into metaphysics. It feels like someone following the maths until it runs out of floor.
...
- Tegmark is a Swedish-American physicist and cosmologist at [MIT](https://en.wikipedia.org/wiki/Massachusetts_Institute_of_Technology), born in Stockholm in 1967, with a PhD from UC Berkeley. He started as a hard-nosed precision cosmologist before becoming known for far bolder ideas.
- His early reputation came from **[cosmic microwave background](https://en.wikipedia.org/wiki/Cosmic_microwave_background)** analysis and large-scale structure - genuinely mainstream work using data from missions like WMAP, including early use of [baryon acoustic oscillations](https://en.wikipedia.org/wiki/Baryon_acoustic_oscillations) as a cosmic "standard ruler".
...
- That top rung is the **[Mathematical Universe Hypothesis](https://en.wikipedia.org/wiki/Mathematical_universe_hypothesis)**: the claim that physical reality is not merely *described by* mathematics but *is* a mathematical structure. I gave this its own [full treatment here](/general/is-reality-made-of-mathematics/).
- He also took a serious swing at consciousness with **"[Consciousness as a State of Matter](https://arxiv.org/abs/1401.1219)"**, coining *perceptronium* - the idea that consciousness might be a state of matter like solid, liquid or gas, defined by how it processes information.
- In the 2010s he pivoted hard toward **AI safety**, co-founding the [Future of Life Institute](https://futureoflife.org/), writing *[Life 3.0](https://en.wikipedia.org/wiki/Life_3.0)*, and helping drive the 2023 [open letter](https://futureoflife.org/open-letter/pause-giant-ai-experiments/) calling for a pause on the largest AI experiments.
...
- **Level II** - in [eternal inflation](https://en.wikipedia.org/wiki/Eternal_inflation), our Big Bang is one bubble among many, and different bubbles can freeze out with different physical constants, different particle content, even different effective dimensions. The laws we treat as fundamental become local weather.
- **Level III** - the [many-worlds](/general/a-new-universe-all-throughout-the-day/) branching of quantum mechanics, where every quantum outcome is realised on some branch of the wavefunction. Tegmark's striking argument is that Level III adds no *new* worlds beyond Level I and II - it reshuffles where the same possibilities live rather than introducing extra ones.
...
Level IV is where Tegmark plants his most famous and most contested flag, and because I have already written about it at length I will keep this short and point you at the [full post](/general/is-reality-made-of-mathematics/).

The short version: Tegmark is not saying reality is beautifully *described* by mathematics. He is saying it *is* mathematics - that our external physical reality is a mathematical structure, that there is no other ingredient, and that you and I are self-aware substructures inside it, existing in the same timeless way the number seven does. He lays it out formally in his 2007 paper [*The Mathematical Universe*](https://arxiv.org/abs/0704.0646) and at book length in *[Our Mathematical Universe](https://en.wikipedia.org/wiki/Our_Mathematical_Universe)* (2014). He later proposed a tamer variant, the Computable Universe Hypothesis, restricting reality to computable structures partly to dodge the trouble that infinities and [Gödel's incompleteness theorems](https://en.wikipedia.org/wiki/G%C3%B6del%27s_incompleteness_theorems) cause for the strong version.
...
- [Is Reality Made of Mathematics?](/general/is-reality-made-of-mathematics/) - the deep dive into Tegmark's Mathematical Universe Hypothesis, the single idea of his I find hardest to put down.
- [Donald Hoffman: The Case That Consciousness Is Fundamental](/ai/donald-hoffman-consciousness-fundamental/) - the opposite bet to Tegmark's, where mind rather than mathematics is the bedrock, and the cleanest foil for his picture.
- [Why Is There Something Rather Than Nothing?](/general/why-is-there-something-rather-than-nothing/) - where I first set down the instinct that mathematics might be the floor of reality, which Tegmark pushes further than anyone.
- [A New Universe All Throughout The Day](/general/a-new-universe-all-throughout-the-day/) - the many-worlds branching that sits at Level III of Tegmark's multiverse hierarchy.
- [Favourite Physicists](/general/favourite-physicists/) - the list Tegmark tops, and the others who have shaped how I think about the deepest layer of reality.
